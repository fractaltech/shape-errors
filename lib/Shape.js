      ...
      if (invalidInputKeys.length > 0) {
        return Promise.reject(new (function (_Error) {
          ...
          function _class() {
            ...
            var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(_class).call(this, JSON.stringify(items), null, 2));
          ...
          if (err) {
            return Promise.reject(new (function (_Error2) {
              ...
              function _class2() {
                ...
                var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(_class2).call(this, JSON.stringify(data, null, 2)));
